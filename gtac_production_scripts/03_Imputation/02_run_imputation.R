  ...
  future_imap(function(fn, i, ...) {
    ...
    rows <-
      ...
      future_map(impute.row, # function
                 ...
                 .progress = FALSE) # future_map params
    ...
    writeRaster(tile_out, 
                ...
                paste0(output_dir,'raster/tiles/',output_name,'_testRows_',row1,'_',row2,'_maxpx',max_px,'_nT',ntiles,'_tile',i,'.tif'),
                overwrite = TRUE)
