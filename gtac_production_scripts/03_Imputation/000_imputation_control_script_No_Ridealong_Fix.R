...
zones_list <- zones_list[zones_list %in% c(10,24,53,66)]
...
# Imputation scripts
project_inputScript <- glue::glue("{this_dir}/00a_project_inputs_for_imp_NoRidealongFix.R")
zone_inputScript <- glue::glue("{this_dir}/00b_zonal_inputs_for_imp.R")
buildImputation_script <-  glue::glue("{this_dir}/01_build_imputation_No_Ridealong_Fix.R")
