...
#for (z in zone_list) {
  ...
  #   } else {}
  # } else {
  #   print("check your calculate_landfire_fire parameter")
  # }
  ...
  #export
  writeRaster(dist_year, glue::glue('{target_dir_z}/disturb_year_LF.tif'),
              overwrite = TRUE)
  writeRaster(dist_type, glue::glue('{target_dir_z}/disturb_code_LF.tif'),
              overwrite = TRUE)
