...
Unique plots imputed in zone: `r unique_pltsZone`

Plots available in zone: `r numPltsZone_XdfModel`

Percent of available plots imputed: `r percent_avlbPlts_imputed`%
...
if(params$eval_type == "OOB") {
  ...
  # list all figures in cross-validation folder
  eval_figs_list <- list.files(glue::glue('{eval_dir}/02_OOB_Evaluation/figs/'), full.names = TRUE, pattern = ".png$") #TODO: make paths dynamic
