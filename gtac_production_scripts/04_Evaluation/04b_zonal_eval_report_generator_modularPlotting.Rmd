...
if(params$eval_type == "CV") {
  ...
  eval_figs_list <- list.files(glue::glue('{eval_dir}/01_Cross_Validation/figs/'), full.names = TRUE, pattern = ".png$")
  
  print(eval_figs_list)
  
  # render graphics in markdown
  knitr::include_graphics(eval_figs_list, rel_path = FALSE, error =TRUE)
...
```{r conditionally plot OOB figures}
