...
if (include_paramTable == "Y"){
  ...
  # params_RDS_path <- glue::glue("{home_dir}/03_Outputs/07_Projects/{project_name}/01_Raw_model_outputs/z{zone_num}/params/z{zone_num}_{project_name}_params.RDS")
  ...
  param_table <- RDS_toTable(params_out)
