...
targetDataProjectInputs <- function(year_input,
  ...
  #target_dir_mask <<- glue::glue("{home_dir}/03_Outputs/05_Target_Rasters/{target_data_version}/post_mask/")
  target_dir_mask <<- glue::glue("{home_dir}/03_Outputs/05_Target_Rasters/{target_data_version}/masked/")
