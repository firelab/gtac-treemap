...
#   names(raw_prob) <- c( "SlowLoss_Raw_Prob", "FastLoss_Raw_Prob", "Gain_Raw_Prob")
# 
...
#     min()
# 
#   # reclassify classes to exclude values below threshold
#   # there's probably slicker way to do this, maybe with purrr?
...
#     mask(NPArea_mask, maskvalue = NAvalue) # mask with NP area mask
# 
#   # #inspect
#   # maxProbClass
...
# lcms_slowloss_years <-
#   lcms_slowloss %>%
#   terra::classify(cbind(c(2,3,4), NA)) %>% # reclass to only slow loss
...
# writeRaster(lcms_slowloss_years, glue('{home_dir}/03_Outputs/01_LCMS_Slow_Loss/01_Rasters/01_SlowLoss/{start_year}_{end_year}_{zone_name}_LCMS_SlowLoss_Years.tif'),
#             overwrite = TRUE)
# writeRaster(lcms_slowloss_binary, glue('{home_dir}/03_Outputs/01_LCMS_Slow_Loss/01_Rasters/01_SlowLoss/{start_year}_{end_year}_{zone_name}_LCMS_SlowLoss_Binary.tif'),
#             overwrite = TRUE)
# 
# #remove unused files
# rm(raw_prob, raw_prob_process, maxProbClass)
# 
# # clear memory
# gc()
# 
...
# landfire_fire_years <- terra::rast("//166.2.126.25/TreeMap/03_Outputs/05_Target_Rasters/01_Disturbance/02_Landfire_Fire/2010_2016_LFz16_UtahHighPlateaus_Landfire_Fire_Years.tif")
# lcms_slowloss_years <- terra::rast("//166.2.126.25/TreeMap/03_Outputs/01_LCMS_Slow_Loss/01_Rasters/01_SlowLoss/2010_2016_LFz16_UtahHighPlateaus_LCMS_SlowLoss_Years.tif")
# 
# landfire_fire_binary <- terra::rast("//166.2.126.25/TreeMap/03_Outputs/05_Target_Rasters/01_Disturbance/02_Landfire_Fire/2010_2016_LFz16_UtahHighPlateaus_Landfire_Fire_Binary.tif")
# lcms_slowloss_binary <- terra::rast("//166.2.126.25/TreeMap/03_Outputs/01_LCMS_Slow_Loss/01_Rasters/01_SlowLoss/2010_2016_LFz16_UtahHighPlateaus_LCMS_SlowLoss_Binary.tif")
