...
var layers = [
  ...
  {band: 'TREEMAP_ID',                                                            name: 'TreeMap ID',                                               shown: false}, 
  ...
  {band: 'SDIsum',            min: 6,   max: 99,    palette: palettesR.bamako_r,  name: 'Sum of Stand Density Index',                               shown: false},
  ...
  {band: 'CARBON_DOWN_DEAD',  min: 0,   max: 15,    palette: palettes.lajolla,    name: 'Carbon, Down Dead (tons/acre)',                            shown: false},
