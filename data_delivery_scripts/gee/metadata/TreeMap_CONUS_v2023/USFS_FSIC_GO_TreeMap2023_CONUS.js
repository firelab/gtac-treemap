//var dataset = ee.ImageCollection('projects/treemap-386222/assets/Final_Outputs/2022/TreeMap2023');
var dataset = ee.ImageCollection('USFS/GTAC/TreeMap/v2023');

var TreeMap = dataset.filter('year == "2023"')
